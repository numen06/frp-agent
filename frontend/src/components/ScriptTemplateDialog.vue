<template>
  <Teleport to="body">
    ...
    >
      ...
      <div
        class="relative z-10 flex max-h-[min(92vh,800px)] w-full max-w-5xl flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl will-change-transform"
        @click.stop
      >
