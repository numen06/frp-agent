...
class ProxySshState(Base):
    ...
    frpc_bin_path = Column(String(500), nullable=True)
    config_path = Column(String(500), nullable=True)
    config_format = Column(String(20), nullable=True)  # toml, ini, unknown
    has_ini = Column(Boolean, nullable=False, default=False)
    has_toml = Column(Boolean, nullable=False, default=False)
    service_name = Column(String(100), nullable=False, default="frpc")
